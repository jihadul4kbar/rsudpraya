...
private void PemeriksaanKeyPressed(java.awt.event.KeyEvent evt) {                                       
...
private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {                                         
   try{
    ...
    private void btnTarifActionPerformed(java.awt.event.ActionEvent evt) {                                         
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void PenjabKeyPressed(java.awt.event.KeyEvent evt) {                                  
        // TODO add your handling code here:
    }                                 

    private void tbTarifMouseClicked(java.awt.event.MouseEvent evt) {                                     
    ...
    private void rbDewasaMouseClicked(java.awt.event.MouseEvent evt) {                                      
        tbTarifMouseClicked(evt);
    }                                     

    private void rbAnakMouseClicked(java.awt.event.MouseEvent evt) {                                    
        tbTarifMouseClicked(evt);
    }                                   
    ...
    private void BtnNotaActionPerformed(java.awt.event.ActionEvent evt) {                                        
        ...
        if(tabMode.getRowCount()==0){
            ...
            Valid.panggilUrl("billing/LaporanBiayaLab.php?norm="+TNoRM.getText()+"&nopriksa="+TNoRw.getText()+"&pasien="+TPasien.getText().replaceAll(" ","_")+"&tanggal="+Tanggal.getSelectedItem()+"&jam="+CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem()+"&pjlab="+NmDokterPj.getText().replaceAll(" ","_")+"&petugas="+NmPtg.getText().replaceAll(" ","_")+"&kasir="+Sequel.cariIsi("select nama from pegawai where nik=?",akses.getkode()));
        }
        this.setCursor(Cursor.getDefaultCursor());
    }                                       
